                ...
                <form method="POST" action="{{ route('admin.login.submit') }}" class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                    ...
                    <div class="mt-5" x-data="{ showPassword: false }">
                        ...
                        <div class="relative">
                            ...
                            <button type="button" @click="showPassword = !showPassword" class="absolute right-4 top-1/2 -translate-y-1/2 text-slate-400 hover:text-primary-700 transition" aria-label="Tampilkan atau sembunyikan kata sandi">
