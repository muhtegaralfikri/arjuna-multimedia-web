    ...
    <div class="relative z-10">
        ...
        <div class="mt-6 flex items-center space-x-4">
            <div class="flex items-center bg-white/10 backdrop-blur-sm rounded-lg px-4 py-2">
                ...
                <span class="text-sm font-medium">{{ \Carbon\Carbon::now()->format('d F Y') }}</span>
            </div>
            <div class="flex items-center bg-white/10 backdrop-blur-sm rounded-lg px-4 py-2">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                </svg>
                <span class="text-sm font-medium">{{ \Carbon\Carbon::now()->format('H:i') }}</span>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="bg-white rounded-xl shadow-md p-6 hover:shadow-xl transition duration-300 border border-gray-100 relative overflow-hidden group">
        ...
        <div class="relative z-10">
            ...
            <div>
                ...
                <p class="text-4xl font-bold text-gray-900">{{ $stats['packages'] }}</p>
            </div>
            <div class="mt-4">
                <a href="{{ route('admin.packages.index') }}" class="inline-flex items-center text-blue-600 hover:text-blue-700 font-medium text-sm group-hover:translate-x-1 transition">
                    Kelola Paket
        ...
        <div class="relative z-10">
            ...
            <div>
                ...
                <div class="flex items-baseline space-x-2">
                    <p class="text-4xl font-bold text-gray-900">{{ $stats['areas'] }}</p>
                    <span class="text-green-600 text-sm font-semibold">+{{ $stats['active_areas'] }} aktif</span>
                </div>
            </div>
            <div class="mt-4">
                <a href="{{ route('admin.areas.index') }}" class="inline-flex items-center text-green-600 hover:text-green-700 font-medium text-sm group-hover:translate-x-1 transition">
                    Kelola Area
                    <svg class="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                    </svg>
    ...
    <div class="bg-white rounded-xl shadow-md p-6 hover:shadow-xl transition duration-300 border border-gray-100 relative overflow-hidden group">
        ...
        <div class="relative z-10">
            ...
            <div>
                ...
                <p class="text-4xl font-bold text-gray-900">{{ $stats['faqs'] }}</p>
            </div>
            <div class="mt-4">
                <a href="{{ route('admin.faqs.index') }}" class="inline-flex items-center text-purple-600 hover:text-purple-700 font-medium text-sm group-hover:translate-x-1 transition">
                    Kelola FAQ
                    <svg class="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                    </svg>
    ...
    <div class="bg-white rounded-xl shadow-md p-6 hover:shadow-xl transition duration-300 border border-gray-100 relative overflow-hidden group">
        ...
        <div class="relative z-10">
            ...
            <div>
                ...
                <div class="flex items-baseline space-x-2">
                    <p class="text-4xl font-bold text-gray-900">{{ $stats['forms'] }}</p>
                    <span class="text-orange-600 text-sm font-semibold">belum diproses</span>
                </div>
            </div>
            <div class="mt-4">
                <a href="{{ route('admin.forms.index') }}" class="inline-flex items-center text-orange-600 hover:text-orange-700 font-medium text-sm group-hover:translate-x-1 transition">
                    Lihat Form
                    <svg class="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                    </svg>
...
{{-- Quick Actions --}}
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    <a href="{{ route('admin.packages.create') }}" class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl p-6 text-white shadow-lg hover:shadow-xl transition transform hover:-translate-y-1 group">
    ...
    <a href="{{ route('admin.areas.create') }}" class="bg-gradient-to-br from-green-500 to-green-600 rounded-xl p-6 text-white shadow-lg hover:shadow-xl transition transform hover:-translate-y-1 group">
        <div class="flex items-center">
            <div class="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center mr-4 group-hover:scale-110 transition">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
    ...
    <a href="{{ route('admin.faqs.create') }}" class="bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl p-6 text-white shadow-lg hover:shadow-xl transition transform hover:-translate-y-1 group">
        <div class="flex items-center">
            <div class="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center mr-4 group-hover:scale-110 transition">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
    ...
    <a href="{{ route('admin.pages.index') }}" class="bg-gradient-to-br from-gray-500 to-gray-600 rounded-xl p-6 text-white shadow-lg hover:shadow-xl transition transform hover:-translate-y-1 group">
        <div class="flex items-center">
            <div class="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center mr-4 group-hover:scale-110 transition">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<div class="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
    <div class="px-6 py-5 border-b border-gray-100 flex items-center justify-between">
        ...
        <a href="{{ route('admin.forms.index') }}" class="inline-flex items-center px-4 py-2 bg-blue-50 text-blue-600 rounded-lg hover:bg-blue-100 transition text-sm font-medium">
            Lihat Semua
            <svg class="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
            </svg>
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50 transition">
                    <td class="py-4 px-6">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-gray-500 text-sm">{{ Str::limit($submission->address, 30) }}</p>
                            </div>
                        </div>
                    </td>
                    <td class="py-4 px-6">
                        <a href="https://wa.me/{{ ltrim($submission->whatsapp, '0') }}" target="_blank" class="inline-flex items-center text-green-600 hover:text-green-700 font-medium transition hover:underline">
                    ...
                    <td class="py-4 px-6 text-gray-600 text-sm">
                        ...
                        <span class="text-gray-400">{{ $submission->created_at->format('H:i') }}</span>
                    </td>
                    <td class="py-4 px-6">
                        <div class="flex items-center space-x-2">
                            <a href="{{ route('admin.forms.show', $submission->id) }}" class="inline-flex items-center px-3 py-1.5 bg-blue-50 text-blue-600 rounded-lg hover:bg-blue-100 transition text-sm font-medium">
                                Detail
                            </a>
                        </div>
                    </td>
...
<div class="mt-8 bg-white rounded-xl shadow-md border border-gray-100 p-6">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
        <a href="{{ route('admin.contacts.edit') }}" class="flex items-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition group">
        ...
        <a href="{{ route('admin.settings.edit') }}" class="flex items-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition group">
        ...
        <a href="{{ route('home') }}" target="_blank" class="flex items-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition group">
        ...
        <a href="{{ route('admin.logout') }}" class="flex items-center p-4 bg-red-50 rounded-lg hover:bg-red-100 transition group">
