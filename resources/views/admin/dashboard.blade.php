...
<div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-6">
    ...
    {{-- Forms Card --}}
    <div class="bg-white rounded-lg border border-slate-200 p-5 shadow-sm hover:shadow-md hover:border-rose-300 transition-all duration-300 group relative overflow-hidden">
        <div class="flex flex-col h-full justify-between relative z-10">
            <div class="flex items-start justify-between mb-4">
                <div class="w-11 h-11 bg-rose-50 rounded-lg flex items-center justify-center text-rose-600 group-hover:bg-rose-500 group-hover:text-white transition-colors duration-300 relative">
                    @if($stats['forms'] > 0)
            ...
            <div>
                <p class="text-slate-500 text-sm font-semibold">Form Minat Baru</p>
                <div class="flex items-end space-x-2 mt-1">
                    <p class="text-3xl font-black text-slate-950 tracking-tight">{{ $stats['forms'] }}</p>
...
<div class="bg-white rounded-lg shadow-sm border border-slate-200 overflow-hidden">
    <div class="px-6 py-5 border-b border-slate-100 flex items-center justify-between bg-white">
        <div>
            <h2 class="text-lg font-black text-slate-950">Form Minat Terbaru</h2>
                ...
                <tr class="hover:bg-slate-50/80 transition-colors group">
                    ...
                    <td class="py-4 px-6 whitespace-nowrap">
                        <a href="https://wa.me/{{ ltrim($submission->whatsapp, '0') }}" target="_blank" class="inline-flex items-center px-3 py-1.5 rounded-lg bg-emerald-50 text-emerald-600 hover:bg-emerald-100 hover:text-emerald-700 transition font-medium text-sm border border-emerald-100">
                            @include('partials.whatsapp-icon', ['class' => 'w-4 h-4 mr-1.5 object-contain'])
                            {{ $submission->whatsapp }}
                        </a>
                    </td>
                    <td class="py-4 px-6 whitespace-nowrap">
    ...
    <div class="text-center py-16 px-4">
        <div class="inline-flex items-center justify-center w-16 h-16 rounded-lg bg-slate-100 mb-4">
            <svg class="w-8 h-8 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 006.586 13H4"/>
            </svg>
        </div>
        <h3 class="text-lg font-bold text-slate-950 mb-1">Belum Ada Form</h3>
