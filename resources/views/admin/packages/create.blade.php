...
<div class="mb-6">
    <h1 class="text-2xl font-bold text-gray-800">Tambah Paket Internet</h1>
    <p class="text-gray-600">Buat paket internet baru</p>
</div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="col-span-2">
                ...
                <textarea id="features" name="features" rows="3"
                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                    placeholder="Unlimited, Support 24/7, Gratis Modem"></textarea>
                @error('features')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
