...
<div class="mb-6 flex items-center justify-between">
    <div>
        ...
        <p class="text-slate-500 text-sm mt-1">Lakukan perubahan pada paket <strong class="text-slate-700">{{ $package->name }}</strong>.</p>
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        <select id="category" name="category" required
                            ...
                            <option value="home" {{ $package->category === 'home' ? 'selected' : '' }}>Paket Rumah (Home)</option>
                            <option value="business" {{ $package->category === 'business' ? 'selected' : '' }}>Paket Bisnis (Business)</option>
                        </select>
                ...
                <div class="col-span-1 md:col-span-2">
                    ...
                    <textarea id="description" name="description" rows="3"
                        ...
                        placeholder="Tuliskan deskripsi promosi dari paket ini...">{{ old('description', $package->description) }}</textarea>
                    @error('description')
                        <p class="mt-1.5 text-sm text-rose-600 flex items-center"><svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/></svg>{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="col-span-1 md:col-span-2">
                    ...
                    <textarea id="features" name="features" rows="3"
                        class="w-full px-4 py-3 bg-slate-50 border border-slate-200 text-slate-900 rounded-xl focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-all shadow-sm resize-y"
                        placeholder="Pisahkan dengan koma (Contoh: Unlimited Tanpa FUP, Pinjaman Router Gratis, Support 24 Jam)">{{ old('features', is_array($package->features) ? implode(', ', $package->features) : '') }}</textarea>
                ...
                <div class="col-span-1 md:col-span-2 flex flex-col sm:flex-row gap-6">
                    <label class="relative flex items-center group cursor-pointer">
                        <input type="checkbox" name="is_active" value="1" {{ $package->is_active ? 'checked' : '' }} class="peer sr-only">
                    ...
                    <label class="relative flex items-center group cursor-pointer">
                        <input type="checkbox" name="is_popular" value="1" {{ $package->is_popular ? 'checked' : '' }} class="peer sr-only">
