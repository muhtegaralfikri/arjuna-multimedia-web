...
<section class="bg-gradient-to-br from-primary-600 to-primary-800 text-white py-20">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h1 class="text-4xl md:text-5xl font-bold mb-4">{{ $page->hero_title ?? 'Tentang Kami' }}</h1>
        <p class="text-xl text-primary-100">{{ $page->hero_subtitle ?? 'Mengenal lebih dekat Arjuna Net' }}</p>
    </div>
</section>
