...
<body class="font-sans antialiased bg-gray-50">
    <div class="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full text-center">
            ...
            <p class="text-gray-600 mb-8">Maaf, terjadi kesalahan pada server kami. Tim teknis kami telah diberitahu dan sedang bekerja untuk memperbaikinya.</p>
            ...
            <div class="mt-12 pt-8 border-t border-gray-200">
                <p class="text-sm text-gray-500">Jika masalah berlanjut, silakan hubungi kami melalui WhatsApp untuk bantuan segera.</p>
            </div>
        </div>
    </div>
</body>
