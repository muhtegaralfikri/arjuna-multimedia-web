...
<body class="font-sans antialiased bg-gray-50">
    <div class="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full text-center">
            <!-- Error Code -->
            <div class="mb-8">
                <h1 class="text-9xl font-bold text-orange-500">403</h1>
            </div>

            <!-- Error Message -->
            <h2 class="text-2xl font-bold text-gray-900 mb-4">Akses Ditolak</h2>
            <p class="text-gray-600 mb-8">Maaf, Anda tidak memiliki izin untuk mengakses halaman ini. Halaman ini khusus untuk administrator.</p>
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a href="{{ url('/admin/login') }}" class="inline-flex items-center justify-center px-6 py-3 border border-gray-300 text-base font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 transition">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
