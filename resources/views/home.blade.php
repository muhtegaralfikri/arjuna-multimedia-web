    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-3xl">
            ...
            <div class="flex flex-col sm:flex-row gap-4">
                @if($contact)
                    <a href="{{ $contact->whatsapp_link }}" target="_blank" class="inline-flex items-center justify-center px-8 py-4 bg-white text-primary-600 rounded-lg font-semibold hover:bg-gray-100 transition">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden border-2 border-primary-500 relative">
                ...
                <div class="p-6">
                    ...
                    <div class="mb-4">
                        <span class="text-4xl font-bold text-primary-600">Rp {{ number_format($package->price_monthly, 0, ',', '.') }}</span>
                    ...
                    @endif
                    @if($contact)
                        <a href="{{ $contact->whatsapp_link_for_package }}?text=Halo%20saya%20tertarik%20dengan%20{{ urlencode($package->name) }}" target="_blank" class="block w-full text-center px-6 py-3 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition">
                            Pesan Sekarang
                        </a>
                    @endif
                </div>
...
<section class="py-16 bg-gradient-to-r from-primary-600 to-primary-800">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <a href="{{ $contact->whatsapp_link }}" target="_blank" class="inline-flex items-center px-8 py-4 bg-white text-primary-600 rounded-lg font-semibold hover:bg-gray-100 transition">
            <svg class="w-6 h-6 mr-2" fill="currentColor" viewBox="0 0 24 24">
                <path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946.003-6.556 5.338-11.891 11.893-11.891 3.181.001 6.167 1.24 8.413 3.488 2.245 2.248 3.481 5.236 3.48 8.414-.003 6.557-5.338 11.892-11.893 11.892-1.99-.001-3.951-.5-5.688-1.448l-6.305 1.654zm6.597-3.807c1.676.995 3.276 1.591 5.392 1.592 5.448 0 9.886-4.434 9.889-9.885.002-5.462-4.415-9.89-9.881-9.892-1.454-.001-2.866.32-4.171.877l-2.633-1.629 1.736 5.737z"/>
            </svg>
