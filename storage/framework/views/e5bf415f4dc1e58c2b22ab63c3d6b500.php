<?php $__env->startSection('pageTitle', 'Edit FAQ'); ?>

<?php $__env->startSection('content'); ?>
<div class="mb-6 flex items-center justify-between">
    <div>
        <h1 class="text-2xl font-bold text-slate-900 tracking-tight">Edit FAQ</h1>
        <p class="text-slate-500 text-sm mt-1">Lakukan perubahan pada pertanyaan dan jawaban ini.</p>
    </div>
        ...
        <form method="POST" action="<?php echo e(route('admin.faqs.update', $faq->id)); ?>">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                ...
                <div class="col-span-1 md:col-span-2">
                    ...
                    <input type="text" id="question" name="question" value="<?php echo e(old('question', $faq->question)); ?>" required
                ...
                <div>
                    ...
                    <div class="relative">
                        <select id="category" name="category" required
                            ...
                            <option value="general" <?php echo e($faq->category === 'general' ? 'selected' : ''); ?>>Umum</option>
                            <option value="technical" <?php echo e($faq->category === 'technical' ? 'selected' : ''); ?>>Teknis</option>
                            <option value="billing" <?php echo e($faq->category === 'billing' ? 'selected' : ''); ?>>Billing (Tagihan)</option>
                            <option value="installation" <?php echo e($faq->category === 'installation' ? 'selected' : ''); ?>>Pemasangan</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="number" id="sort_order" name="sort_order" value="<?php echo e(old('sort_order', $faq->sort_order)); ?>"
                        class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 text-slate-900 rounded-xl focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-all shadow-sm"
                        placeholder="1">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-span-1 md:col-span-2">
                    ...
                    <textarea id="answer" name="answer" rows="6" required
                        ...
                        placeholder="Jawaban lengkap untuk pertanyaan di atas..."><?php echo e(old('answer', $faq->answer)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-span-1 md:col-span-2">
                    <label class="relative flex items-center group cursor-pointer w-max">
                        <input type="checkbox" name="is_published" value="1" <?php echo e($faq->is_published ? 'checked' : ''); ?> class="peer sr-only">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\github_project\arjuna-multimedia-web\resources\views/admin/faqs/edit.blade.php ENDPATH**/ ?>