...
<body class="font-sans antialiased text-gray-900 bg-gray-50">
        ...
        <nav class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-24 md:h-28">
                ...
                <div class="hidden md:flex items-center space-x-6">
                    ...
                    <a href="<?php echo e(route('support')); ?>" class="text-gray-700 hover:text-primary-600 transition <?php if(request()->is('bantuan')): ?> text-primary-600 font-semibold <?php endif; ?>">Bantuan</a>
                ...
                <?php if($contact = \App\Models\Contact::getContact()): ?>
                    <div class="hidden md:block">
                        <a href="<?php echo e(route('wa.general')); ?>" target="_blank" class="inline-flex items-center px-4 py-2 bg-green-500 text-white rounded-lg font-semibold hover:bg-green-600 transition">
            ...
            <div id="publicMobileMenu" class="md:hidden hidden">
                <div class="px-2 pt-2 pb-3 space-y-1 bg-white border-t border-gray-100 shadow-md">
                    ...
                    <a href="<?php echo e(route('support')); ?>" class="block px-3 py-2 rounded-lg text-gray-700 hover:bg-gray-100 <?php if(request()->is('bantuan')): ?> bg-primary-50 text-primary-600 <?php endif; ?>">Bantuan</a>
                    ...
                    <?php if($contact = \App\Models\Contact::getContact()): ?>
                        <a href="<?php echo e(route('wa.general')); ?>" target="_blank" class="flex items-center px-3 py-2 rounded-lg bg-green-50 text-green-700 font-semibold hover:bg-green-100">
                            <?php echo $__env->make('partials.whatsapp-icon', ['class' => 'w-5 h-5 mr-2 object-contain'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            Hubungi Kami
                        </a>
                    <?php endif; ?>
                    ...
                    <ul class="space-y-3 text-gray-400">
                        <li class="flex items-start">
                            ...
                            <span class="space-y-1">
                                <a href="<?php echo e(route('wa.general')); ?>" target="_blank" class="block hover:text-white transition"><?php echo e($contact->whatsapp_number); ?></a>
                                <?php if($contact->phone_number): ?>
                                    <a href="tel:<?php echo e($contact->phone_number); ?>" class="block hover:text-white transition"><?php echo e($contact->phone_number); ?></a>
                                <?php endif; ?>
                            </span>
                        </li>
                        <li class="flex items-start">
    ...
    <?php if($contact = \App\Models\Contact::getContact()): ?>
        <a href="<?php echo e(route('wa.general')); ?>" target="_blank" class="fixed bottom-6 right-6 z-50 bg-green-500 p-2 rounded-full shadow-lg hover:bg-green-600 hover:scale-105 transition md:hidden">
