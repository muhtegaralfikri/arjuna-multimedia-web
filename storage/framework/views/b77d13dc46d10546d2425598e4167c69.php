        ...
        <div class="flex flex-col h-full justify-between relative z-10">
            ...
            <div>
                ...
                <div class="flex items-end space-x-2 mt-1">
                    <p class="text-3xl font-extrabold text-slate-800 tracking-tight"><?php echo e($stats['packages']); ?></p>
                </div>
            </div>
        </div>
        <a href="<?php echo e(route('admin.packages.index')); ?>" class="absolute inset-0"></a>
    </div>
        ...
        <div class="flex flex-col h-full justify-between relative z-10">
            <div class="flex items-start justify-between mb-4">
                ...
                <span class="inline-flex items-center px-2 py-1 bg-emerald-50 text-emerald-700 text-xs font-semibold rounded-md border border-emerald-100">
                    <?php echo e($stats['active_areas']); ?> Aktif
                </span>
            </div>
            <div>
                <p class="text-slate-500 text-sm font-medium">Total Area</p>
                <div class="flex items-end space-x-2 mt-1">
                    <p class="text-3xl font-extrabold text-slate-800 tracking-tight"><?php echo e($stats['areas']); ?></p>
                </div>
            </div>
        </div>
        <a href="<?php echo e(route('admin.areas.index')); ?>" class="absolute inset-0"></a>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-slate-200/60 p-6 shadow-sm hover:shadow-md hover:border-amber-300 transition-all duration-300 group relative overflow-hidden">
        ...
        <div class="flex flex-col h-full justify-between relative z-10">
            ...
            <div>
                ...
                <div class="flex items-end space-x-2 mt-1">
                    <p class="text-3xl font-extrabold text-slate-800 tracking-tight"><?php echo e($stats['faqs']); ?></p>
                </div>
            </div>
        </div>
        <a href="<?php echo e(route('admin.faqs.index')); ?>" class="absolute inset-0"></a>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-slate-200/60 p-6 shadow-sm hover:shadow-md hover:border-rose-300 transition-all duration-300 group relative overflow-hidden">
        ...
        <div class="flex flex-col h-full justify-between relative z-10">
            ...
            <div>
                ...
                <div class="flex items-end space-x-2 mt-1">
                    <p class="text-3xl font-extrabold text-slate-800 tracking-tight"><?php echo e($stats['forms']); ?></p>
                    <p class="text-rose-600 text-sm font-semibold mb-1">Menunggu</p>
                </div>
            </div>
        </div>
        <a href="<?php echo e(route('admin.forms.index')); ?>" class="absolute inset-0"></a>
    </div>
</div>
...
<div class="bg-white rounded-2xl shadow-sm border border-slate-200/60 overflow-hidden">
    <div class="px-6 py-5 border-b border-slate-100 flex items-center justify-between bg-white">
        ...
        <a href="<?php echo e(route('admin.forms.index')); ?>" class="inline-flex items-center px-4 py-2 bg-slate-50 border border-slate-200 text-slate-600 rounded-lg focus:outline-none hover:bg-slate-100 transition-colors text-sm font-medium shadow-sm">
            Lihat Semua
                ...
                <tr class="hover:bg-slate-50/80 transition-colors group">
                    <td class="py-4 px-6 whitespace-nowrap">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <div class="text-sm font-semibold text-slate-900"><?php echo e($submission->name); ?></div>
                                <div class="text-sm text-slate-500 truncate max-w-[200px]" title="<?php echo e($submission->address); ?>"><?php echo e($submission->address); ?></div>
                            </div>
                        </div>
                    </td>
                    <td class="py-4 px-6 whitespace-nowrap">
                        <a href="https://wa.me/<?php echo e(ltrim($submission->whatsapp, '0')); ?>" target="_blank" class="inline-flex items-center px-3 py-1.5 rounded-lg bg-emerald-50 text-emerald-600 hover:bg-emerald-100 hover:text-emerald-700 transition font-medium text-sm border border-emerald-100">
                    ...
                    <td class="py-4 px-6 whitespace-nowrap text-right font-medium">
                        <a href="<?php echo e(route('admin.forms.show', $submission->id)); ?>" class="inline-flex items-center justify-center p-2 rounded-lg bg-white border border-slate-200 text-indigo-600 hover:bg-indigo-50 hover:border-indigo-200 transition-colors shadow-sm">
