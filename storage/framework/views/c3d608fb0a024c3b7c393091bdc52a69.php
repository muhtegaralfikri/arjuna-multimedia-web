...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mt-10 pt-6 border-t border-slate-100 flex justify-end space-x-4">
                <a href="<?php echo e(route('admin.areas.index')); ?>" class="px-6 py-2.5 border border-slate-300 text-slate-700 font-semibold rounded-xl hover:bg-slate-50 hover:text-slate-900 transition-colors">
                    Batal
                </a>
